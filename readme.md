[![Build Status](https://travis-ci.org/ZanichelliEditore/LearningRecordStore-xapi.svg?branch=master)](https://travis-ci.org/ZanichelliEditore/LearningRecordStore-xapi)
